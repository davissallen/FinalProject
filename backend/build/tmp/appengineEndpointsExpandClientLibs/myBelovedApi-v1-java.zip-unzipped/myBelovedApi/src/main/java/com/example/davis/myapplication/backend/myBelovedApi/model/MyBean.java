...
package com.example.davis.myapplication.backend.myBelovedApi.model;

/**
 * Model definition for MyBean.
 *
 * <p> This is the Java data model class that specifies how to parse/serialize into the JSON that is
 * transmitted over HTTP when working with the myBelovedApi. For a detailed explanation see:
