 ...
 * on 2017-08-16 at 03:51:06 UTC 
 * Modify at your own risk.
 */

package com.example.davis.myapplication.backend.myBelovedApi;

/**
 * Service definition for MyBelovedApi (v1).
 *
 * <p>
 * This is an API
 * </p>
 ...
 *
 * <p>
 * This service uses {@link MyBelovedApiRequestInitializer} to initialize global parameters via its
 * {@link Builder}.
 * </p>
 *
 * @since 1.3
...
public class MyBelovedApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.22.0 of the myBelovedApi library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
   ...
   * @since 1.7
   */
  public static final String DEFAULT_SERVICE_PATH = "myBelovedApi/v1/";
   ...
   * @since 1.7
   */
  public MyBelovedApi(com.google.api.client.http.HttpTransport transport, com.google.api.client.json.JsonFactory jsonFactory,
   ...
   *
   * This request holds the parameters needed by the myBelovedApi server.  After setting any optional
  ...
  public class GetJoke extends MyBelovedApiRequest<com.example.davis.myapplication.backend.myBelovedApi.model.MyBean> {
     ...
     * Create a request for the method "getJoke".
     *
     * This request holds the parameters needed by the the myBelovedApi server.  After setting any
     ...
     */
    protected GetJoke() {
      super(MyBelovedApi.this, "GET", REST_PATH, null, com.example.davis.myapplication.backend.myBelovedApi.model.MyBean.class);
    }
  ...
  public class SayHi extends MyBelovedApiRequest<com.example.davis.myapplication.backend.myBelovedApi.model.MyBean> {
    ...
    protected SayHi(java.lang.String name) {
      super(MyBelovedApi.this, "POST", REST_PATH, null, com.example.davis.myapplication.backend.myBelovedApi.model.MyBean.class);
  ...
  public static final class Builder extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient.Builder {
    ...
    /** Builds a new instance of {@link MyBelovedApi}. */
    @Override
    public MyBelovedApi build() {
      return new MyBelovedApi(this);
    }
    ...
    /**
     * Set the {@link MyBelovedApiRequestInitializer}.
     *
     * @since 1.12
     */
    public Builder setMyBelovedApiRequestInitializer(
        MyBelovedApiRequestInitializer mybelovedapiRequestInitializer) {
      return (Builder) super.setGoogleClientRequestInitializer(mybelovedapiRequestInitializer);
    }
